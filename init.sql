...
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS branch VARCHAR(255);
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS pipeline_source VARCHAR(50);
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS job_name VARCHAR(255);
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS project_name VARCHAR(255);
ALTER TABLE sessions ADD COLUMN IF NOT EXISTS merge_request_id VARCHAR(50);